...
**[项目介绍](#项目介绍) · [功能一览](#功能一览) · [开始观星](#开始观星) · [数据与模型](#数据与模型) · [本地运行](#本地运行) · [参与项目](#参与项目) · [许可证](#许可证)**
...
2. **先改变位置，再比较天空。** 打开“位置”，从太阳邻域前往内银河或盘面上方。左侧按钮控制看向的方向；位置面板控制你在哪里。
